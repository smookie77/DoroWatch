...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x2, 0x7b, 0xef, 0xff, 0xff, 0xd9, 0x50,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x8, 0xff, 0x60,
    0x1, 0xdf, 0xc0, 0x0, 0x0, 0x0, 0x0, 0x3,
    0xbf, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x92,
    0x0, 0x0, 0x0, 0x0, 0x1f, 0xf6, 0x0, 0x0,
    0x3f, 0xf2, 0x0, 0x0, 0x0, 0x0, 0x9f, 0xff,
    0xff, 0xc8, 0x53, 0x22, 0x46, 0xaf, 0xff, 0xa1,
    0x0, 0x0, 0x0, 0x4f, 0xf0, 0x0, 0x0, 0xf,
    0xf4, 0x0, 0x0, 0x0, 0x1c, 0xff, 0xff, 0x81,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x6e, 0xff, 0x60,
    0xb, 0xf1, 0x4f, 0xe0, 0x0, 0x0, 0xe, 0xf4,
    0x0, 0x0, 0x1, 0xdf, 0xff, 0xb1, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x9f, 0xfa, 0xc,
    0xf1, 0x2f, 0xf1, 0x0, 0x0, 0xf, 0xf2, 0x0,
    0x0, 0xc, 0xff, 0xf9, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x6, 0xff, 0xcd, 0xf1,
    0xd, 0xf8, 0x0, 0x0, 0x6f, 0xd0, 0x0, 0x0,
    0x9f, 0xff, 0x90, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x6f, 0xff, 0xf1, 0x4,
    0xff, 0xa5, 0x49, 0xff, 0x40, 0x0, 0x5, 0xff,
    0xfb, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x8, 0xff, 0xf1, 0x0, 0x4e,
    0xff, 0xff, 0xe4, 0x0, 0x0, 0xe, 0xff, 0xf1,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0xef, 0xf1, 0x0, 0x0, 0x47,
    0x75, 0x0, 0x0, 0x0, 0x8f, 0xff, 0x80, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    ...
    0x0, 0x3, 0x9f, 0xff, 0x70, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x7, 0xff, 0xff, 0xff, 0xb7, 0x64, 0x45, 0x7a,
    0xef, 0xff, 0xd3, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x3c, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xe6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x4b, 0xff, 0xff, 0xff, 0xff, 0xff, 0xc5, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x3, 0x67, 0x89, 0x76, 0x40, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 41238, .adv_w = 960, .box_w = 46, .box_h = 46, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 42296, .adv_w = 960, .box_w = 60, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 44126, .adv_w = 960, .box_w = 60, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 45476, .adv_w = 960, .box_w = 60, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 47066, .adv_w = 960, .box_w = 60, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 48416, .adv_w = 660, .box_w = 42, .box_h = 43, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 49319, .adv_w = 960, .box_w = 59, .box_h = 60, .ofs_x = 0, .ofs_y = -7},
    {.bitmap_index = 51089, .adv_w = 960, .box_w = 57, .box_h = 61, .ofs_x = 2, .ofs_y = -8},
    {.bitmap_index = 52828, .adv_w = 1080, .box_w = 68, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 54630, .adv_w = 960, .box_w = 60, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 56460, .adv_w = 1080, .box_w = 68, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 57990, .adv_w = 960, .box_w = 60, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 59820, .adv_w = 480, .box_w = 30, .box_h = 47, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 60525, .adv_w = 720, .box_w = 45, .box_h = 47, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 61583, .adv_w = 1080, .box_w = 68, .box_h = 57, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 63521, .adv_w = 960, .box_w = 60, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 64871, .adv_w = 840, .box_w = 38, .box_h = 55, .ofs_x = 7, .ofs_y = -5},
    {.bitmap_index = 65916, .adv_w = 840, .box_w = 53, .box_h = 63, .ofs_x = 0, .ofs_y = -9},
    {.bitmap_index = 67586, .adv_w = 840, .box_w = 53, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 68991, .adv_w = 840, .box_w = 53, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 70396, .adv_w = 840, .box_w = 38, .box_h = 55, .ofs_x = 7, .ofs_y = -5},
    {.bitmap_index = 71441, .adv_w = 840, .box_w = 55, .box_h = 53, .ofs_x = -1, .ofs_y = -4},
    {.bitmap_index = 72899, .adv_w = 600, .box_w = 32, .box_h = 53, .ofs_x = 3, .ofs_y = -4},
    {.bitmap_index = 73747, .adv_w = 600, .box_w = 32, .box_h = 53, .ofs_x = 3, .ofs_y = -4},
    {.bitmap_index = 74595, .adv_w = 840, .box_w = 53, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 76000, .adv_w = 840, .box_w = 53, .box_h = 13, .ofs_x = 0, .ofs_y = 16},
    {.bitmap_index = 76345, .adv_w = 1080, .box_w = 68, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 77875, .adv_w = 1200, .box_w = 75, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 80163, .adv_w = 1080, .box_w = 70, .box_h = 61, .ofs_x = -1, .ofs_y = -8},
    {.bitmap_index = 82298, .adv_w = 960, .box_w = 60, .box_h = 55, .ofs_x = 0, .ofs_y = -5},
    {.bitmap_index = 83948, .adv_w = 840, .box_w = 52, .box_h = 33, .ofs_x = 0, .ofs_y = 6},
    {.bitmap_index = 84806, .adv_w = 840, .box_w = 52, .box_h = 33, .ofs_x = 0, .ofs_y = 6},
    {.bitmap_index = 85664, .adv_w = 1200, .box_w = 75, .box_h = 47, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 87427, .adv_w = 960, .box_w = 60, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 88777, .adv_w = 960, .box_w = 60, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 90607, .adv_w = 960, .box_w = 61, .box_h = 61, .ofs_x = -1, .ofs_y = -8},
    {.bitmap_index = 92468, .adv_w = 840, .box_w = 54, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 93899, .adv_w = 840, .box_w = 53, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 95516, .adv_w = 840, .box_w = 53, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 96921, .adv_w = 600, .box_w = 39, .box_h = 61, .ofs_x = -1, .ofs_y = -8},
    {.bitmap_index = 98111, .adv_w = 840, .box_w = 53, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 99728, .adv_w = 840, .box_w = 53, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 101345, .adv_w = 1080, .box_w = 68, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 102875, .adv_w = 960, .box_w = 62, .box_h = 62, .ofs_x = -1, .ofs_y = -8},
    {.bitmap_index = 104797, .adv_w = 720, .box_w = 45, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 106170, .adv_w = 1200, .box_w = 75, .box_h = 55, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 108233, .adv_w = 1200, .box_w = 75, .box_h = 39, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 109696, .adv_w = 1200, .box_w = 75, .box_h = 39, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 111159, .adv_w = 1200, .box_w = 75, .box_h = 39, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 112622, .adv_w = 1200, .box_w = 75, .box_h = 39, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 114085, .adv_w = 1200, .box_w = 75, .box_h = 39, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 115548, .adv_w = 1200, .box_w = 76, .box_h = 47, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 117334, .adv_w = 840, .box_w = 46, .box_h = 61, .ofs_x = 3, .ofs_y = -8},
    {.bitmap_index = 118737, .adv_w = 840, .box_w = 53, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 120354, .adv_w = 960, .box_w = 61, .box_h = 61, .ofs_x = -1, .ofs_y = -8},
    {.bitmap_index = 122215, .adv_w = 1200, .box_w = 75, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 123903, .adv_w = 720, .box_w = 45, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 125276, .adv_w = 966, .box_w = 61, .box_h = 39, .ofs_x = 0, .ofs_y = 3}
};
